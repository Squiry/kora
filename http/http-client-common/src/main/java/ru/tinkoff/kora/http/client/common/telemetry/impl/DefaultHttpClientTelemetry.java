...
public class DefaultHttpClientTelemetry implements HttpClientTelemetry {
    ...
    public DefaultHttpClientTelemetry(HttpClientTelemetryConfig config, @Nullable Tracer tracer, @Nullable DefaultHttpClientLogger logger, @Nullable DefaultHttpClientMetrics metrics) {
        this.config = config;
        this.tracer = tracer;
        this.logger = logger;
