...
import ru.tinkoff.kora.aws.s3.BaseS3Client;
...
class KnownSizeAwsChunkedHttpBody implements HttpBodyOutput {
    ...
    private final BaseS3Client.ContentWriter contentWriter;
    ...
    public KnownSizeAwsChunkedHttpBody(AwsRequestSigner signer, String region, int uploadChunkSize, String contentType, String rqSignature, BaseS3Client.ContentWriter contentWriter, long streamLength, @Nullable String sha256Base64) {
        this.region = region;
        this.signer = signer;
